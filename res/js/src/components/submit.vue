			...
			<div class="submit-page">
				<div v-if="$store.state.currentUser">
					...
					<form @submit.prevent="save" @click="message = ''" @keydown="message = ''">
						...
						<p style="font-style:italic; color:rgb(135,135,135); padding:0 0 1em;">This can be found by pressing the downward arrow in the top right corner on your tweet, and then clicking "Copy link to tweet."</p>	
